...
>>>>>>> 7f6be96e7d1bae37053f2ccf0b1ecd09767a7f07
                ...
                <button class="stone_btn stone_btn_submit width_full margin_top_15" id="submit" @click="login">登录
                </button>
                <div class="login_link">
                    <a href="http://www.iplaystone.com/static/web/resetPwd.html?lang=cn" class="login_forget">忘记密码？</a>
                    <a href="http://www.iplaystone.com/static/web/register.html?lang=cn&amp;history=http%3A%2F%2Fwww.iplaystone.com%2F"
                       class="loginp_register">立即注册</a>
                </div>
            </div>
        </div>
    </div>
