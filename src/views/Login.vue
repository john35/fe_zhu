<template>
  ...
  <div class="login_body">
    ...
    <div class="stone_line">
      <input id="userName" class="stone_input_icon input_error" type="text">
      <i class="stone_icon stone_user"></i>
      <div class="stone_input_error" style="display: block;">用户名不能为空</div>
    </div>
    <div class="stone_line">
      <input id="pwd" class="stone_input_icon" type="text">
      <i class="stone_icon stone_pwd"></i>
      <div class="stone_input_error"></div>
    </div>
    <button class="stone_btn stone_btn_submit width_full margin_top_15" id="submit">登录</button>
    <div class="login_link">
      <a href="http://www.iplaystone.com/static/web/resetPwd.html?lang=cn" class="login_forget">忘记密码？</a>
      <a href="http://www.iplaystone.com/static/web/register.html?lang=cn&amp;history=http%3A%2F%2Fwww.iplaystone.com%2F" class="loginp_register">立即注册</a>
    </div>
  </div>
</div>
  </div>
