    ...
    <div class="stone_register_center stone_body_cover">
      <div class="stone_body_main">
        <div id="register">
          ...
          <div class="stone_body_line">
            <input type="password" class="width_full" id="pwd" placeholder="密码" v-model="pwd" />
            <div v-bind:class="{stone_line_error:isPwdActive}">{{pwdErr}}</div>
          </div>
          <div class="stone_body_line">
            <input type="password" class="width_full" id="repwd" placeholder="验证密码" v-model="repwd" />
            <div v-bind:class="{stone_line_error:isPActive}">{{rpwdErr}}</div>
          </div>

          <button
            class="stone_btn stone_btn_submit width_full"
          ...
          <div class="isgologin">
            已有账号，
            <a
              href="http://www.iplaystone.com/static/web/login.html?lang=cn&amp;history=http%3A%2F%2Fwww.iplaystone.com%2F&amp;sso="
            >立即登录</a>
          </div>
        </div>
      ...
      if (
        ...
        this.$store
          ...
          .then(
            res => {
              console.log('444')
              this.$message.success("注册成功，请到你的邮箱验证");
            },
            data => {
...
.stone_register_header .stone_header_logo {
  width: 135px;
  height: 38px;
  background: url(http://www.iplaystone.com/static/common/images/logo2.png)
    no-repeat;
...
.stone_body_main .stone_body_line .stone_line_middle {
  background: url("http://www.iplaystone.com/images/middle.png") center
    no-repeat;
}

.stone_body_main .stone_body_line .stone_line_strong {
  background: url("http://www.iplaystone.com/images/strong.png") center
    no-repeat;
}
...
.stone_header .stone_header_logo {
  ...
  width: 175px;
  height: 100%;
  background: url(http://www.iplaystone.com/static/common/images/LOGO.png)
    no-repeat 0 16px;
}
...
.stone_header .stone_serch .serch_input:-moz-placeholder {
...
.stone_header .stone_serch .serch_input:-ms-input-placeholder {
...
.stone_header .stone_serch .serch_btn {
  ...
  right: 8px;
  cursor: pointer;
  background: url(http://www.iplaystone.com/static/common/images/search.png)
    no-repeat center;
}
.stone_serch .bor {
  position: absolute;
...
.stone_serch .bor ul li:first-child .rec_num {
  background: url(http://www.iplaystone.com/images/rec_num1.png) no-repeat
    center;
}
.stone_serch .bor ul li:nth-child(2) .rec_num {
  background: url(http://www.iplaystone.com/images/rec_num2.png) no-repeat
    center;
}
.stone_serch .bor ul li:nth-child(3) .rec_num {
  background: url(http://www.iplaystone.com/images/rec_num3.png) no-repeat
    center;
}
...
.stone_header .stone_user_btn .stone_btn_cart {
  background: url("http://www.iplaystone.com/static/common/images/shopping.png")
    no-repeat;
}

.stone_header .stone_user_btn .stone_btn_client {
  padding-right: 0px;
  background: url(http://www.iplaystone.com/static/common/images/download.png)
...
.login_pop .login_pop_input .login_pop_error {
  ...
  padding-left: 15px;
  color: red;
  background: url("http://www.iplaystone.com/static/common/images/error.png")
    left no-repeat;
}
...
.stone_footer_container .stone_footer_stone > span {
  ...
  font-size: 14px;
  padding-left: 60px;
  background: url("http://www.iplaystone.com/images/footer_stone_logo.png")
    no-repeat left;
}
...
.switch_lang_selecte {
  ...
  height: 91px;
  padding-top: 10px;
  background: url("http://www.iplaystone.com/static/common/images/login_bg.png")
    no-repeat center;
}
...
.switch_lang_cn_btn:hover,
.switch_lang_en_btn:hover {
