            ...
            <div class="stone_body_main">
                <div id="register">
                    <div class="stone_body_line">
                        <input class="width_full input_error" id="user" type="text" v-model="user">
                        <div class="stone_line_error" style="display: block;">注册账号不能为空</div>
                    </div>
                    <div class="stone_body_line">
                        <input type="text" class="width_full" id="pwd" v-model="pwd">
                        <div class="stone_line_error">3</div>
                    </div>
                    <div class="stone_body_line">
                        <input type="text" class="width_full" id="repwd" v-model="repwd">
                        <div class="stone_line_error">4</div>
                    </div>
<!--                    <div class="stone_body_line">-->
<!--                        <label class="stone_line_order">点击注册代表同意</label>-->
<!--                        <a target="_blank" href="http://www.iplaystone.com/static/web/agreement.html">《Stone用户注册协议》</a>-->
<!--                        <div class="stone_line_error"></div>-->
<!--                    </div>-->

                    <button class="stone_btn stone_btn_submit width_full" @click="register">注册</button>
...
<style>
    ...
    .login_header .login_header_logo {
        float: left;
        width: 115px;
        height: 38px;
        background: url('http://www.iplaystone.com/static/common/images/LOGO.png') no-repeat 0;
    }
    ...
    .stone_header {
        ...
        width: 100%;
        z-index: 9;
        background: url(http://www.iplaystone.com/static/common/images/hdbg.jpg) no-repeat center;
    ...
    .stone_serch .bor ul li:first-child .rec_num {
        background: url(http://www.iplaystone.com/static/common/images/rec_num1.png) no-repeat center;
    }

    .stone_serch .bor ul li:nth-child(2) .rec_num {
        background: url(http://www.iplaystone.com/static/common/images/rec_num2.png) no-repeat center;
    }

    .stone_serch .bor ul li:nth-child(3) .rec_num {
        background: url(http://www.iplaystone.com/static/common/images/rec_num3.png) no-repeat center;
    }
    ...
    .stont_footer_weibo {
        background: url('http://www.iplaystone.com/static/common/images/wb.png') no-repeat center;
    ...
    .stont_footer_weixin {
        margin-left: 5px;
        background: url('http://www.iplaystone.com/static/common/images/wx.png') no-repeat center;
        background-position: 0 0;
    }
    ...
    */
    ...
    .stont_footer_weixin > div {
        ...
        height: 122px;
        display: none;
        background: url(http://www.iplaystone.com/static/common/images/weixin_code.png) no-repeat;
        z-index: 2;
    }
    ...
    .stone_footer_container .stone_footer_stone > span {
        ...
        font-size: 14px;
        padding-left: 60px;
        background: url('http://www.iplaystone.com/static/common/images/footer_stone_logo.png') no-repeat left;
    }
    ...
    .stone_btn_resend .stone_btn_resend_click {
        ...
        width: 100%;
        height: 100%;
        background: url('http://www.iplaystone.com/static/common/images/tranparent.png');
    ...
    .switch_lang_en_btn {
        background-image: url(http://www.iplaystone.com/static/common/images/enbtn.png);
    }

    .switch_lang_cn_btn {
        background-image: url(http://www.iplaystone.com/static/common/images/zhbtn.png);
    }
    ...
    .nav_tab span {
        ...
        color: rgb(64, 64, 64);
        font-weight: bold;
        background: url(http://www.iplaystone.com/static/common/images/logo2.png) no-repeat left;
    }
    ...
    .stone_service_service {
        background-image: url('http://www.iplaystone.com/static/common/images/service.png');
    }
    ...
    .stone_back_top {
        ...
        height: 45px;
        cursor: pointer;
        background: url('http://www.iplaystone.com/static/common/images/top.png') no-repeat center;
